...
gulp.task('compile-js', function() {
  return gulp.src([bowerpath+ 'jquery/dist/jquery.min.js', bowerpath+ 'tether/dist/js/tether.min.js', bowerpath+ 'bootstrap/dist/js/bootstrap.min.js', 'js/*'])
    .pipe(concat('app.js'))
...
gulp.task('compile-js', function() {
  ...
  bowerpath+ 'holderjs/holder.min.js', // Holder.js for project development only
  'js/main.js'])
  .pipe(concat('app.js'))
  .pipe(gulp.dest('./_site/js/'));
});
